    ...
    <thead>
        <tr class='success'>
            <th colspan='4' align='center' style='text-align: center; '>
                ...
                <button class="pull-right action_js_export_to_pdf btn btn-default btn-sm d-print-none" data-question-id="quid_<?php echo $outputs['parentqid'];?>" data-bs-toggle="tooltip" title="<?php eT('Export this question to PDF.'); ?>">
